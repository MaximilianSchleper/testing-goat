...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_layout_and_styling(self):
        ...
        # Her browers window is set to a very specific size
        ...
        # She starts a new list and see the input is nicely centered too
    ...
    def test_can_start_a_todo_list(self):
        ...
        # She is invited to ende a to-do item straigt away
        inputbox = self.browser.find_element(By.ID, "id_new_item")
        ...
        # "1: Buy peacoock feathers" as an item in a to-do list
        inputbox.send_keys(Keys.ENTER)
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## We delete all the browsers's cookies
